...
fn textures_single_texture() {
    let buf: &[u8] = &[b'T', b'E', b'S', b'T', b' ', b'T', b'E', b'X', b'T', b'U', b'R', b'E', b' ', b' ', b' ', b' ', // name (padded to 64 bytes)
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       0x43, 0x00, 0x04, 0x00, // surface flags
    ...
    assert_eq!(lump.textures[0].surface, SurfaceFlags::NO_DAMAGE | SurfaceFlags::SLICK | SurfaceFlags::FLESH | SurfaceFlags::DUST);
    assert_eq!(lump.textures[0].contents, ContentsFlags::SOLID | ContentsFlags::LAVA);
}

#[test]
fn textures_multiple_textures() {
    let buf: &[u8] = &[b'T', b'E', b'S', b'T', b' ', b'T', b'E', b'X', b'T', b'U', b'R', b'E', b'1', b' ', b' ', b' ', // name (padded to 64 bytes)
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       0x43, 0x00, 0x04, 0x00, // surface flags
                       0x09, 0x00, 0x00, 0x00,  // contents flags
                       b'T', b'E', b'S', b'T', b' ', b'T', b'E', b'X', b'T', b'U', b'R', b'E', b'2', b' ', b' ', b' ', // name (padded to 64 bytes)
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       0x2c, 0x10, 0x00, 0x00, // surface flags
                       0x01, 0x00, 0x00, 0x00,  // contents flags
                       b'T', b'E', b'S', b'T', b' ', b'T', b'E', b'X', b'T', b'U', b'R', b'E', b'3', b' ', b' ', b' ', // name (padded to 64 bytes)
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ', b' ',
                       0x00, 0x0a, 0x00, 0x00, // surface flags
    ...
    assert_eq!(lump.textures[0].surface, SurfaceFlags::NO_DAMAGE | SurfaceFlags::SLICK | SurfaceFlags::FLESH | SurfaceFlags::DUST);
    assert_eq!(lump.textures[1].surface, SurfaceFlags::METAL_STEPS | SurfaceFlags::NO_MARKS | SurfaceFlags::LADDER | SurfaceFlags::SKY);
    assert_eq!(lump.textures[2].surface, SurfaceFlags::POINT_LIGHT | SurfaceFlags::SKIP);

    assert_eq!(lump.textures[0].contents, ContentsFlags::SOLID | ContentsFlags::LAVA);
    assert_eq!(lump.textures[1].contents, ContentsFlags::SOLID);
    assert_eq!(lump.textures[2].contents, ContentsFlags::SOLID | ContentsFlags::FOG);
